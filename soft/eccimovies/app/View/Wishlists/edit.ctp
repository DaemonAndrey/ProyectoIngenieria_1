    ...
    <div>
        ...
        <div class="row text-center" id="movie-info">
            ...
            <?php foreach($wishlistProducts as $wishlistProduct): ?>
                    <div class="col-md-3">
                        <p id="imagen">
                            <?php echo $this->Html->link($this->Html->image(($wishlistProduct['Product']['code'].'.jpg'),
                                                                            array('alt' =>  $wishlistProduct['Product']['name'],
                                                                                  'id' => 'movies-picture-img'
                                                                                 )
                                                                           ),
                                                         array('controller'=>'Products',
                                                               'action' => 'view', $wishlistProduct['Product']['id']
                                                              ),
                        ...
                        <?php
                        if($wishlistProduct['Product']['format'] === 'DVD')
                        { 
                            ?>
                            <p>
                        ...
                        <p id="details-movie">
                            <?php echo $this->Html->link($wishlistProduct['Product']['name'],
                                                         array('controller'=>'Products',
                                                               'action' => 'view',
                        ...
                        <p id="remove-wishlist">
                            <?php
                            echo $this->Form->postLink($this->Html->image(('notification_error.jpg'),
                                                                          array('alt' =>  'remove',
                                                                                'id' => 'delete-img'
                                                                               )
                                                                         ),
                                                       array('action' => 'removeProductFromWishlist',
                                                             $wishlistProduct['id'],
                                                             $post['Wishlist']['id']),
                                                       array('escape' => false,
