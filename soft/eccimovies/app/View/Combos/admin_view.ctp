...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Combo'), array('action' => 'delete', $combo['Combo']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $combo['Combo']['id']))); ?> </li>
